 ...
 *         np.ndarray[DTYPE_t, ndim=2] anchors,int H, int W, DTYPE_t x_ratio, DTYPE_t y_ratio):
 */
  __pyx_tuple__7 = PyTuple_Pack(6, __pyx_n_s_bbox_pred, __pyx_n_s_anchors, __pyx_n_s_H, __pyx_n_s_W, __pyx_n_s_x_ratio, __pyx_n_s_y_ratio); if (unlikely(!__pyx_tuple__7)) __PYX_ERR(0, 13, __pyx_L1_error)
