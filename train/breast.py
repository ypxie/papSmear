...
def set_args():
    ...
    parser.add_argument('--img_size',   default=[256, 384], help='output image size')
    ...
    parser.add_argument('--load_from_epoch', type=int, default= 15000, help = 'load from epoch')
...
if  __name__ == '__main__':
    ...
    # Dataloader setting
    dataloader = Dataset(data_root, args.batch_size, img_shape = (256, 256), resize_ratio=[0.5,0.7,0.8,0.9,1], aug_rate=30)
