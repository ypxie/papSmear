...
from papSmear.cfgs.config_breast import cfg
...
def set_args():
    ...
    parser.add_argument('--maxepoch',        type=int,   default=40000,    help='number of epochs to train (default: 10)')
    ...
    parser.add_argument('--save_freq',       type=int, default= 1000,  help='how frequent to save the model')
...
if  __name__ == '__main__':
    ...
    # Dataloader setting
    dataloader = Dataset(data_root, args.batch_size, img_shape = (256, 256), resize_ratio=cfg.resize_ratio, aug_rate=30)
